...
#####
# This is a custom 'getting started' script, made with care for azzmodious@gmail.com.
...
streamer = Streamer(bucket_name="Python Stream Example", bucket_key="python_example", access_key="ih3p0TC7hzDDmQ9ULMkFkliN2xREG9DP")
